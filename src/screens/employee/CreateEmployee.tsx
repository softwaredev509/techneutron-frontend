...
import { useCreateEmployeeMutation } from '../../services/employee/EmployeeApi';
...
const CreateEmployee = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values: EmployeeFormData) => {
            ...
            try {
                const response: CreatedEmployeeResponse = await createEmployee(values)
                console.log("Response when employee created: ",response);
